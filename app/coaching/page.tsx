        ...
        <div className="max-w-6xl mx-auto">
          <div className="max-w-3xl">
            ...
            <h1 className="font-heading text-5xl md:text-6xl text-navy leading-tight mb-4">
              ...
              <span className="italic">It's a practice.</span>
            </h1>
            <div className="section-divider mb-6" />
            <p className="text-base text-navy/65 leading-relaxed max-w-2xl">
              Every coaching engagement is tailored entirely to you — your situation, your pace, your goals. Below is an overview of the primary areas Anjali works in.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            ...
            title="Coaching for life's most demanding moments"
          />
              ...
              <div
                ...
                className={`rounded-3xl p-8 md:p-10 border ${
                  i === 0
                    ...
                    : "bg-warm-white border-gold-light/40 hover:border-gold/30 hover:shadow-sm"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                  <div className="md:col-span-2">
                    ...
                    <p
                      className={`text-sm leading-relaxed mb-6 ${
                        i === 0 ? "text-warm-white/75" : "text-navy/65"
                      }`}
                    >
                      {service.description}
                    </p>
                  ...
                  <div
                    className={`rounded-2xl p-6 ${
                      i === 0 ? "bg-white/5 border border-white/10" : "bg-beige border border-gold-light/30"
                    }`}
                  >
                    <div className="flex items-center gap-2 mb-3">
                      <Clock size={14} className={i === 0 ? "text-gold" : "text-gold"} />
                      <span
                        className={`text-xs tracking-wide ${
                          i === 0 ? "text-warm-white/60" : "text-navy/50"
                        }`}
                      >
                        {service.duration}
                      </span>
                    ...
                    <div className="flex items-center gap-2">
                      <Video size={14} className={i === 0 ? "text-gold" : "text-gold"} />
                      <span
                        className={`text-xs tracking-wide ${
                          i === 0 ? "text-warm-white/60" : "text-navy/50"
                        }`}
      ...
      <section className="py-20 px-6 bg-beige">
        <div className="max-w-6xl mx-auto">
          <SectionHeading
            ...
            title="Who this coaching is for — and who it is not"
            centered
          />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-12">
            <div>
              <h3 className="font-heading text-xl text-navy mb-6 flex items-center gap-3">
                <span className="w-8 h-8 rounded-full bg-gold/15 flex items-center justify-center">
            ...
            <div>
              ...
              <div className="mt-8 p-5 rounded-2xl bg-warm-white border border-gold-light/40">
                <p className="text-xs text-navy/60 leading-relaxed">
                  <strong className="text-navy">Note:</strong> Coaching is not therapy. If you're dealing with clinical mental health conditions, please seek support from a licensed mental health professional. Anjali can discuss this further in your exploratory call.
                </p>
              </div>
            </div>
          </div>
