...
const values = [
  { title: "Emotional Honesty", description: "A commitment to naming what is actually present — without dramatising or dismissing it." },
  { title: "Non-Directive Guidance", description: "You are the expert on your own life. Coaching helps you access that expertise, not override it." },
  { title: "Whole-Person Thinking", description: "Your career, relationships, inner life, and values are not separate — they inform each other." },
  { title: "Depth Over Speed", description: "Real clarity rarely comes from quick fixes. The work is gentle, patient, and sustainable." },
];
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h1 className="font-heading text-5xl md:text-6xl text-navy leading-tight mb-4">
                A coach who understands <span className="italic">complexity</span>
              </h1>
              <div className="section-divider mb-6" />
              <p className="text-base text-navy/65 leading-relaxed">
                Anjali Raj is a certified Change & Clarity Coach based in New Delhi, working with clients across India and internationally.
              </p>
            </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          <SectionHeading eyebrow="Her Story" title="The journey to this work" />
          <div className="mt-8 space-y-5 text-navy/70 text-base leading-relaxed">
            <p>Anjali's path to coaching was not a straight line — it was itself a season of change. After years in corporate environments and navigating her own complex personal transitions, she found that the most transformative moments in her life came not from external advice, but from conversations that helped her access her own clarity.</p>
            <p>That insight became the foundation of her coaching practice. She trained formally through the NeuroLeadership Institute — an ICF-accredited program grounded in neuroscience and applied psychology — and deepened her practice through NLP certification with Vikram Dhar and TalentPlus tools.</p>
            <p>Today, she works with individuals across India and internationally who are at pivotal moments: career crossroads, relationship decisions, personal reinvention, and the often-unnamed confusion of feeling stuck despite doing everything "right."</p>
            <p>What makes her coaching different is the quality of presence she brings. Clients often describe her style as calm, incisive, and deeply human — a space where they can think without pressure and feel without judgment.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <SectionHeading eyebrow="The Difference" title="Why clients choose this approach" subtitle="Coaching is everywhere. But not all coaching feels the same." />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {siteConfig.credentials.map((cred) => (
              <div key={cred} className="px-6 py-3 rounded-full border border-gold/30 text-warm-white/80 text-sm">{cred}</div>
            ))}
          </div>
        </div>
      </section>
