      ...
      <section className="pt-32 pb-20 px-6 gradient-warm">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-heading text-5xl md:text-6xl text-navy leading-tight mb-4">
            How coaching <span className="italic">actually works</span>
          </h1>
          <div className="section-divider mb-6" />
          <p className="text-base text-navy/65 leading-relaxed max-w-2xl">
            Coaching is not a prescription or a performance. It's a structured yet deeply human process — one that meets you exactly where you are.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-navy">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
            {[
              { time: "First 10 min", label: "Opening", description: "Where are you right now? What's present for you today? We begin with check-in." },
              { time: "Next 40 min", label: "The Work", description: "Exploring the situation, the feelings, the blocks, the patterns. Going deeper." },
              { time: "Final 10 min", label: "Integration", description: "What did you notice? What's shifted? What will you take into the week ahead?" },
            ].map((block) => (
